// Пользователь вводит систему счисления (в диапазоне [2..36]) 
// и затем числа в этой системе счисления. Окончанием ввода является 
// ввод лексемы “Stop”. Найдите среди введённых чисел максимальное по модулю.
// Выведите на консоль значение найденного максимального по модулю числа в 
// системах счисления с основаниями 9, 18, 27, 36.
