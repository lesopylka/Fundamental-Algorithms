...
// 37 строка: убери unreachable code
// 44 строка: проверки на корректность выделения памяти нет, пофиксить с возможностью обработки ситуации в вызывающем коде
// не увидел функции с переменным числом аргументов - не по заданию сделано то есть, допиливай